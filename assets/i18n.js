(() => {
  ...
  const translations = {
    de: {
      ...
      "pos.info": "Info",
      "pos.sell": "Verkauf",
      "pos.voucher": "Gutschein",
      "pos.free": "Gratis",
      "pos.storno.button": "Storno letzte Buchung",
      "pos.storno.confirm": "Letzte Buchung wirklich stornieren?",
      "pos.storno.error.offline": "Storno nur online möglich",
      "pos.storno.error.queueNotEmpty": "Storno nicht möglich, solange Buchungen in der Warteschlange sind",
      "pos.storno.error.generic": "Storno fehlgeschlagen",
      "pos.storno.success": "Storno durchgeführt",
      "pos.book.success": "Buchung erfolgreich",
      "pos.book.offline": "Offline - In Queue gespeichert",
      "pos.book.error": "Buchung fehlgeschlagen",
      ...
      "admin.settings.tabletTypeReset": "Tablet Typ Reset (Sek)",
    ...
    en: {
      ...
      "pos.voucher": "Voucher",
      "pos.free": "Free",
      "pos.storno.button": "Storno last booking",
      "pos.storno.confirm": "Really cancel last booking?",
      "pos.storno.error.offline": "Storno only possible online",
      "pos.storno.error.queueNotEmpty": "Storno not possible while bookings are in queue",
      "pos.storno.error.generic": "Storno failed",
      "pos.storno.success": "Storno successful",
      "pos.book.success": "Booking successful",
      "pos.book.offline": "Offline - saved in queue",
      "pos.book.error": "Booking failed",
      ...
      "admin.settings.tabletTypeReset": "Tablet type reset (sec)",
