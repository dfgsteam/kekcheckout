(() => {
  ...
  const translations = {
    de: {
      "title.index": "Kek-Counter",
      "title.admin": "Kek-Counter Admin",
      "title.analysis": "Kek-Counter Analyse",
      "title.display": "Kek-Counter Display",
      ...
      "index.tagline": "Live Counter",
      "index.subtitle": "Schneller Ueberblick und Verlauf in Echtzeit.",
      "index.counter.present": "Anwesend",
      "index.counter.critical": "Kritisch ab",
      "index.chart.title": "Verlauf",
      "index.chart.subtitle": "Letzte Updates im Blick.",
      "index.chart.series": "Belegung",
      "index.modal.title": "Access-Token",
      "index.modal.note": "Token wird nur lokal im Browser gespeichert.",
      "index.modal.placeholder": "Token",
      "index.modal.status.none": "Kein Token gespeichert",
      "chart.visitors": "Besucher",
      "chart.visitorsAria": "Visitors Verlauf",
      "chart.occupancyLabel": "Belegung: {count}",
      "chart.visitorsLabel": "Besucher: {count}",
      ...
      "admin.subtitle": "Veranstaltung, CSV und Zugang verwalten.",
      ...
      "admin.event.title": "Veranstaltung",
      "admin.event.note": "Startet eine neue CSV und archiviert die alte.",
      "admin.event.restart": "Neustarten",
      "admin.event.nameLabel": "Veranstaltungsname",
      "admin.event.namePlaceholder": "z.B. Sommerfest",
      "admin.settings.title": "Einstellungen",
      "admin.settings.note": "Zentrale Defaults fuer App und Analyse.",
      ...
      "admin.accessToken.note": "Setzt den Access-Token fuer +1/-1.",
      "admin.accessToken.placeholder": "Neues Access-Token",
      ...
      "admin.archive.title": "CSV-Archiv",
      "admin.archive.downloadLatest": "Letzte CSV herunterladen",
    ...
    en: {
      "title.index": "Kek-Counter",
      "title.admin": "Kek-Counter Admin",
      "title.analysis": "Kek-Counter Analysis",
      "title.display": "Kek-Counter Display",
      "title.indexCount": "{base} - {count}",
      ...
      "index.tagline": "Live counter",
      "index.subtitle": "Quick overview and live history.",
      "index.counter.present": "Present",
      "index.counter.critical": "Critical at",
      "index.chart.title": "History",
      "index.chart.subtitle": "Latest updates at a glance.",
      "index.chart.series": "Occupancy",
      "index.modal.title": "Access token",
      ...
      "chart.visitorsAria": "Visitors history",
      "chart.occupancyLabel": "Occupancy: {count}",
      "chart.visitorsLabel": "Visitors: {count}",
      "chart.retentionLabel": "Retention: {value}%",
